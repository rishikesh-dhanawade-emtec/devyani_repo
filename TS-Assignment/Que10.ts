...
class Student{
    ...
    constructor(rollNo:number, studentName:string, course:string, marks:{[key: string]: number}){
        this.rollNo = rollNo
   ...
   static acceptData(rollNo:number, studentName:string, course:string, marks:{[key: string]: number}){
   ...
   static printData(){
        ...
        const index = studentRecord.findIndex((item: any) => item.rollNo == rollNo)
...
const func1 = (rollNo:number, studentName:string, course:string, marks:{[key: string]: number}) => {
